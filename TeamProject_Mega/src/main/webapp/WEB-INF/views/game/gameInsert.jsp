...
<!DOCTYPE html>
	...
	<body>
		<form method="POST" action="/gameInsert.do">
			...
			<p>출시일 : <input name = "game_release_date" value="sysdate"></p>
			<p>이미지경로 : <input name = "game_image_path" value="test"></p>
			<p>유튜브URL : <input name = "game_youtube_url" value="test"></p>
			<p>MetaCritic점수 : <input name = "game_meta_score" value="55"></p>
			<p>사용자후기점수 : <input name = "game_user_score" value="2.5"></p>
